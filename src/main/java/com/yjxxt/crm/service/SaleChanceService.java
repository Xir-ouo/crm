...
public class SaleChanceService extends BaseService<SaleChance,Integer> {
    ...
    public void addSaleChance(SaleChance saleChance){
        ...
        //设定默认值state devResult(0--未开发,1--开发中,2--开发成功了,3--开发失败)
    ...
    private void checkSaleChanceParam(String customerName,String linkMan,String linkPhone) {
        AssertUtil.isTrue(StringUtils.isBlank(customerName),"请输入客户名字^o^");
        AssertUtil.isTrue(StringUtils.isBlank(linkMan),"请输入联系人^o^");
        AssertUtil.isTrue(StringUtils.isBlank(linkPhone),"请输入联系人手机号码^o^");
        AssertUtil.isTrue(!PhoneUtil.isMobile(linkPhone),"请输入合法的手机号=_=");
    }
